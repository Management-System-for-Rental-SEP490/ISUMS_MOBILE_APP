/**
 * Parse payload SSE/WebSocket: JSON một object / dòng `data:`.
 * eventId + type + createdAt + title bắt buộc; entityId/entityType bắt buộc chỉ khi category có đích điều hướng
 * (xem `categoryRequiresEntityIdForNavigation`). SYSTEM/broadcast có thể không có entityId.
 */
