export default {
    ...
    "google_login_interrupted": "Googleログインが中断されました。もう一度お試しください。",
    ...
    "profile": {
        ...
        "change_password_success_message": "パスワードが正常に更新されました。",
        "change_password_success_message_relogin": "パスワードが変更されました。新しいパスワードで再度ログインしてください。",
        "app_settings": "アプリ設定",
        "settings": "設定",
        "settings_desc": "言語とアプリの設定",
        "notifications": "通知",
        ...
        "relocation_entry_title": "住み替え申請",
        "relocation_entry_subtitle": "別の住戸へ移る申請を送信します",
        "relocation_link_old_title": "この契約は代替されました",
        "relocation_link_new_title": "代替契約",
        "relocation_link_replaced_by": "代替先: {{code}}",
        "relocation_link_replaces": "代替元: {{code}}",
        "relocation_link_kind_active_lease": "入居者の住み替え希望",
        "relocation_link_kind_pre_handover": "引渡し前の住み替え",
        "relocation_link_kind_landlord_fault": "旧物件の居住不可",
        "relocation_title": "住み替え申請",
        "relocation_current_house": "現在の住戸",
        "relocation_select_house": "選択可能な住戸",
        "relocation_house_id": "移転先住戸ID",
        "relocation_house_id_placeholder": "住戸IDを入力または選択",
        "relocation_reason": "理由",
        "relocation_reason_placeholder": "管理者確認用の理由を入力",
        "relocation_submit": "申請を送信",
        "relocation_missing_house": "移転先住戸IDを選択または入力してください。",
        "relocation_same_house": "移転先は現在の住戸と異なる必要があります。",
        "relocation_missing_reason": "住み替え理由を入力してください。",
        "relocation_success_title": "申請を送信しました",
        "relocation_success_message": "管理者が住み替え申請を確認して回答します。",
        "relocation_submit_error": "住み替え申請を送信できませんでした。もう一度お試しください。",
        "relocation_quote_title": "住み替え見積",
        "relocation_quote_new_deposit": "新しい保証金",
        "relocation_quote_transferred_deposit": "移行される保証金",
        "relocation_quote_additional_payment": "追加支払額",
        "relocation_quote_accept": "見積を承認",
        "relocation_quote_accepted_title": "承認しました",
        "relocation_quote_accepted_message": "管理者が署名と支払い用の代替契約を作成します。",
        "relocation_quote_accept_error": "見積を承認できませんでした。もう一度お試しください。",
        "relocation_badge_available": "空室",
        "relocation_badge_bookable": "敷金で予約可",
        "relocation_handover_from": "引渡し予定日：{{date}}",
        "relocation_handover_notice": "前の入居者が{{date}}に引き渡した後、入居していただきます。",
        "relocation_no_houses_title": "現在空き物件がありません",
        "relocation_no_houses_message": "管理者が空き物件のリストを随時更新します。後ほど再度お試しください。",
        "relocation_search_placeholder": "名前・住所・町・区で検索...",
        "relocation_no_match": "条件に一致する物件はありません。",
        "relocation_no_address": "住所が未設定です。",
        "relocation_floors": "階",
        "relocation_selected_caption": "選択中",
        "relocation_cancel_btn": "引っ越し依頼をキャンセル",
        "relocation_cancel_confirm_title": "この引っ越し依頼をキャンセルしますか？",
        "relocation_cancel_confirm_message": "キャンセル後、再度引っ越したい場合は新しい依頼を作成する必要があります。",
        "relocation_cancel_confirm_ok": "依頼をキャンセル",
        "relocation_cancel_done_title": "キャンセル完了",
        "relocation_cancel_done_message": "引っ越し依頼をキャンセルしました。",
        "relocation_cancel_error": "依頼をキャンセルできませんでした。もう一度お試しください。",
        "relocation_status_requested": "管理者確認待ち",
        "relocation_status_quoted": "見積承認待ち",
        "relocation_status_approved": "承認済み、代替契約待ち",
        "relocation_status_contract_created": "代替契約作成済み",
    ...
    "settings": {
        ...
        "language_section": "言語",
        "language_title": "表示言語",
        "language_description": "アプリの表示とシステムから取得する物件データに適用されます。",
        ...
        "theme_title": "カラーテーマ",
        "theme_description": "ライト/ダーク/システム連動を切り替え。",
        "theme_system": "システム",
        "theme_light": "ライト",
        "theme_dark": "ダーク",
        "font_scale_title": "文字サイズ",
        "font_scale_description": "アプリ全体の文字スケールを調整します。",
        "font_scale_xs": "極小",
        "font_scale_sm": "小",
        "font_scale_base": "標準",
        "font_scale_lg": "大",
        ...
        "font_scale_2xl": "最大",
        "density_title": "表示密度",
        "density_description": "要素間の余白を調整します。",
        "density_comfortable": "ゆったり",
        "density_compact": "コンパクト",
        "motion_title": "モーション",
        "motion_description": "酔いやすい場合は減らしてください。",
        "motion_system": "システム",
        "motion_full": "フル",
        "motion_reduced": "減らす",
        "feedback_section": "フィードバックとアラート",
        "haptic_title": "触覚フィードバック",
        "haptic_description": "タップやしきい値超過時に振動。",
        "haptic_intensity_title": "振動の強さ",
        "haptic_intensity_light": "弱",
        "haptic_intensity_medium": "中",
        "alert_sound_title": "アラート音",
        "alert_sound_description": "CRITICAL アラート時に音を鳴らす。",
        "iot_section": "電気・水道のモニタリング",
        "iot_default_range_title": "デフォルト期間",
        "iot_default_range_description": "グラフを開いた時のデフォルト期間。",
        "iot_range_1h": "1時間",
        "iot_range_24h": "24時間",
        "iot_range_7d": "7日間",
        "iot_range_30d": "30日間",
        "iot_range_90d": "90日間",
        "iot_live_interval_title": "リアルタイム更新間隔",
        "iot_live_interval_description": "ライブ値の更新頻度。",
        "iot_live_interval_5": "5秒",
        "iot_live_interval_10": "10秒",
        "iot_live_interval_30": "30秒",
        "iot_live_interval_60": "1分",
        "iot_live_interval_0": "手動",
        "iot_show_cost_title": "請求額の試算を表示",
        "iot_show_cost_description": "段階制料金で kWh / m³ を VND に換算。",
        "iot_show_carbon_title": "カーボンフットプリントを表示",
        "iot_show_carbon_description": "kWh × ベトナム電力網 CO₂ 係数。",
        "iot_show_confidence_title": "予測の信頼区間を表示",
        "iot_show_confidence_description": "予測線周辺の ±X 帯。",
        "iot_show_threshold_bands_title": "グラフにしきい値を表示",
        "iot_show_threshold_bands_description": "min/max を超えた領域を強調。",
        "iot_curve_style_title": "グラフ線のスタイル",
        "iot_curve_smooth": "スムーズ (曲線)",
        "iot_curve_linear": "直線",
        "iot_curve_step": "ステップ",
        "iot_auto_refresh_title": "アプリ復帰時に自動更新",
        "iot_auto_refresh_description": "IoT 画面に戻った時に最新データを取得。",
        "notifications_section": "通知",
        "notifications_prefs_title": "通知設定",
        "notifications_prefs_desc": "受信チャネル、サブスク、音声同意、エスカレーション",
        "voice_history_title": "通話履歴",
        "voice_history_desc": "受信した IoT アラート通話",
        "push_enabled_title": "プッシュ通知を有効化",
        "push_enabled_description": "ISUMS からのプッシュ通知を受信。",
        "quiet_hours_title": "サイレント時間",
        "quiet_hours_description": "この時間帯は通知をミュート。",
        "critical_override_title": "サイレント中も重大アラートは受信",
        "critical_override_description": "CRITICAL (火災、ガス漏れ等) はサイレントを無視。",
        "domain_electric": "電気",
        "domain_water": "水",
        "domain_air": "空気",
        "domain_security": "セキュリティ",
        "domain_gas": "ガス",
        "weekly_digest_title": "週次サマリー",
        "weekly_digest_description": "毎週の使用量・コストをメールで受信。",
        "digest_day_title": "サマリー受信曜日",
        "weekday_0": "日曜日",
        "weekday_1": "月曜日",
        "weekday_2": "火曜日",
        "weekday_3": "水曜日",
        ...
        "weekday_6": "土曜日",
        "bills_section": "請求と予算",
        "tariff_plan_title": "電気料金プラン",
        "tariff_plan_residential_tier": "EVN 家庭用段階制",
        "tariff_plan_flat": "定額",
        "tariff_plan_tou": "時間帯別 (TOU)",
        "currency_title": "通貨",
        "currency_VND": "VND (₫)",
        "currency_USD": "USD ($)",
        "currency_JPY": "JPY (¥)",
        "monthly_budget_title": "月の支出上限",
        "monthly_budget_placeholder": "例 1,500,000 ₫",
        "electric_budget_title": "電気上限 (kWh/月)",
        "water_budget_title": "水道上限 (m³/月)",
        "display_section": "表示",
        "live_badge_title": "LIVE バッジを表示",
        "live_badge_description": "リアルタイム配信中は緑のドット。",
        "area_sparklines_title": "エリアごとのスパークラインを表示",
        "area_sparklines_description": "部屋名の隣に7日間のミニグラフ。",
        "decimal_precision_title": "小数点以下の精度",
        "decimal_precision_0": "0桁 (切り上げ)",
        "decimal_precision_1": "1桁 (12.5)",
        "decimal_precision_2": "2桁 (12.45)",
        "time_format_title": "時刻表示",
        "time_format_24h": "24時間 (14:30)",
        "time_format_12h": "12時間 (2:30 PM)",
        "week_starts_title": "週の始まり",
        "week_starts_monday": "月曜日",
        "week_starts_sunday": "日曜日",
        "privacy_section": "プライバシー",
        "analytics_title": "利用解析を許可",
        "analytics_description": "アプリ改善に使用、個人情報は収集しません。",
        "crash_reports_title": "クラッシュレポート送信",
        "crash_reports_description": "クラッシュ時のログを自動送信。",
        "location_title": "位置情報アクセス",
        "location_description": "住所に基づく天気表示を有効化。",
        "advanced_section": "詳細",
        "reset_title": "デフォルトに戻す",
        "reset_description": "すべての設定を初期値に戻します。",
        "reset_confirm_title": "設定をリセットしますか？",
        "reset_confirm_message": "個人設定がすべて消去されデフォルトに戻ります。この操作は取り消せません。",
        "reset_confirm_action": "リセット",
        "save_success": "保存しました",
    ...
    "home": {
        ...
        "utility_premium": "プラン購入",
        "utility_premium_renew": "更新",
        "premium_badge_title": "PREMIUM 利用中",
        "premium_badge_expires": "{{date}} に終了",
        "premium_badge_a11y": "PREMIUM プランをご利用中です。タップで詳細を表示。",
        ...
        "house_detail": {
            ...
            "reason_label": "メモ:",
            "relocate_here_title": "この物件に引っ越す",
            "relocate_here_subtitle": "管理者の承認を経て代替契約を作成するためのリクエストを送信します。"
        },
        "marketplace": {
            "title": "引っ越せる物件",
            "subtitle": "即入居可、または敷金で予約",
            "badge_available": "空室",
            "badge_bookable": "予約",
            "handover_from": "引渡し：{{date}}",
            "handover_now": "即入居可"
        },
        "house_access_status": {
            "ACCESSIBLE": "利用可能",
    ...
    "tenant_payment": {
        ...
        "quote_already_paid_body":
            "この請求書に紐づく見積はすでに支払い済みです。一覧を引き下げて更新し、状態をご確認ください。それでも未払いと表示される場合は、サポートにご連絡のうえ照合をご依頼ください。",
    ...
    "consumption": {
        ...
        "forecast_title": "今月のAI予測",
        "forecast_confidence_range": "範囲 {{lower}}–{{upper}} {{unit}}",
        "forecast_used_so_far": "{{used}} / {{total}} {{unit}} 使用済み",
        "forecast_days_left_zero": "今月は終了しました",
        "forecast_days_left_one": "残り {{n}} 日",
        "forecast_days_left_other": "残り {{n}} 日",
        "forecast_days_left": "残り {{n}} 日",
        "forecast_next_days_one": "今後 {{n}} 日の予測",
        "forecast_next_days_other": "今後 {{n}} 日の予測",
        "forecast_next_days": "今後 {{n}} 日の予測",
        "forecast_legend_mean": "平均",
        "forecast_legend_band": "信頼区間",
        "forecast_training_rows_one": "学習 {{n}} 日",
        "forecast_training_rows_other": "学習 {{n}} 日",
        "forecast_training_rows": "学習 {{n}} 日",
        "forecast_updated_seconds": "{{n}}秒前に更新",
        "forecast_updated_minutes": "{{n}}分前に更新",
        "forecast_updated_hours": "{{n}}時間前に更新",
        "forecast_updated_days": "{{n}}日前に更新",
        "forecast_empty": "予測に必要なデータが不足しています",
        "forecast_empty_hint": "AIは最低1日分の消費履歴が必要です。計測が安定したあと予測が表示されます。",
        "forecast_projected_label": "月末までの予測",
        "forecast_actual_label": "今月の実績",
        "forecast_uncertainty": "誤差 ±{{pm}} {{unit}}",
        "forecast_lead_one": "今後{{n}}日で約 {{remaining}} {{unit}} の追加消費を見込みます。",
        "forecast_lead_other": "今後{{n}}日で約 {{remaining}} {{unit}} の追加消費を見込みます。",
        "forecast_lead": "今後{{n}}日で約 {{remaining}} {{unit}} の追加消費を見込みます。",
        "forecast_used_label": "使用済み {{n}} {{unit}}",
        "forecast_remaining_label": "予測 {{n}} {{unit}}",
        "forecast_insight_higher": "月初の平均 {{avg}} {{unit}}/日 より {{pct}}% 高い消費が見込まれます。",
        "forecast_insight_lower": "月初の平均 {{avg}} {{unit}}/日 より {{pct}}% 低い消費が見込まれます。",
        "forecast_show_details": "モデル詳細を表示",
        "forecast_hide_details": "詳細を隠す",
        "forecast_details_toggle": "モデル詳細",
        "forecast_detail_method": "手法",
        "forecast_detail_training": "学習データ",
        "forecast_detail_confidence": "信頼区間",
        "forecast_detail_updated": "更新",
        "forecast_projected_total_a11y": "予測合計 {{total}} {{unit}}",
        "forecast_remaining_a11y_one": "今後{{n}}日で追加 {{remaining}} {{unit}}",
        "forecast_remaining_a11y_other": "今後{{n}}日で追加 {{remaining}} {{unit}}",
        "forecast_remaining_a11y": "今後{{n}}日で追加 {{remaining}} {{unit}}",
        "forecast_month_ended": "今月は終了しました。次のサイクルは来月初から始まります。",
        "forecast_quality": {
            "reliable": "AI 信頼性高",
            "provisional": "推定値",
            "warmup": "データ学習中"
        },
        "forecast_error": "予測を取得できません",
        "forecast_error_hint": "予測サーバーが応答しません。接続を確認し、しばらく後に再試行してください。",
        "forecast_retry": "再試行",
        "forecast_stale": "古いデータ",
        "master_power_on_btn": "家全体をオン",
        "master_power_off_btn": "家全体をオフ",
        "master_power_loading": "各エリアの電源状態を確認中…",
        "master_power_scope_one": "IoTスイッチがある {{n}} エリアに影響",
        "master_power_scope_other": "IoTスイッチがある {{n}} エリアに影響",
        "master_power_scope": "IoTスイッチがある {{n}} エリアに影響",
        "master_power_confirm_off_title": "家全体の電源を切りますか?",
        "master_power_confirm_off_body_one": "{{n}} エリアの電源を同時に切断します。稼働中の機器は即停止します。",
        "master_power_confirm_off_body_other": "{{n}} エリアの電源を同時に切断します。稼働中の機器は即停止します。",
        "master_power_confirm_off_body": "{{n}} エリアの電源を同時に切断します。稼働中の機器は即停止します。",
        "master_power_confirm_on_title": "家全体の電源を入れますか?",
        "master_power_confirm_on_body_one": "{{n}} エリアに電源を戻します。",
        "master_power_confirm_on_body_other": "{{n}} エリアに電源を戻します。",
        "master_power_confirm_on_body": "{{n}} エリアに電源を戻します。",
        "master_power_done_title": "完了",
        "master_power_off_success_one": "{{n}} エリアの電源を切りました。",
        "master_power_off_success_other": "{{n}} エリアの電源を切りました。",
        "master_power_off_success": "{{n}} エリアの電源を切りました。",
        "master_power_on_success_one": "{{n}} エリアの電源を入れました。",
        "master_power_on_success_other": "{{n}} エリアの電源を入れました。",
        "master_power_on_success": "{{n}} エリアの電源を入れました。",
        "master_power_partial_title": "一部のエリアが失敗",
        "master_power_partial_body": "成功 {{ok}}/{{total}}。失敗 {{fail}}:\n{{failedList}}",
        "forecast_tier": {
            "prophet_monthly": "AI · Prophet (月)",
            "prophet_weekly": "AI · Prophet (週)",
            "estimate_b": "加重推定",
            "run_rate": "短期ランレート",
            "naive_mtd": "ウォームアップ"
        },
        ...
        "forecast_method": {
            "prophet_monthly": "Prophet 月次 + 日本/VN祝日",
            "prophet_weekly": "Prophet 週次 + 祝日補正",
            "estimate_b": "加重ブレンド",
            "run_rate": "直近3日平均",
            "naive_mtd": "MTD フラット外挿"
        },
    },
    "notification": {
        "empty": "通知はありません",
    ...
    "notif": {
        "prefs": {
            ...
            "voiceQuota": "今月の音声通話",
            "smsQuota": "今月のSMS",
            "upgradeHint": "PREMIUM(月19,000đ)にアップグレードすると、緊急アラートを音声とSMSで受け取れます。",
            "upgradeBtn": "PREMIUMを購入(月19,000đ)",
            "upgrading": "処理中...",
            "upgradeTitle": "PREMIUMを購入",
            "upgradeIntentMsg": "{{provider}}で{{amount}}đ ({{months}}ヶ月分) の支払いリクエストを作成しました。決済完了後、管理者が有効化します。",
            "language": "通知言語",
            "channels": "通知チャネル",
            "email": "メール",
            "emailDesc": "メールでのアラートとレポート",
            "push": "アプリ内プッシュ",
            "pushDesc": "アプリ起動中のリアルタイム通知",
            "sms": "SMS",
            "smsDesc": "CRITICAL/WARNINGイベントのSMS",
            "voice": "音声通話",
            "voiceDesc": "アラートを希望言語で読み上げる電話",
            "premiumOnly": "PREMIUM限定",
            "consentRequired": "音声通話の同意が必要",
            "voiceConsent": "音声通話の同意",
            "voiceConsentDesc": "IoT緊急アラート(ガス、火災、停電、漏水)の音声通話を許可してください。いつでも撤回できます。",
            "grantConsent": "音声通話を許可",
            "revokeConsent": "同意を撤回",
            "testVoice": "テスト通話",
            "fireTest": "今すぐ電話",
            "testing": "発信中...",
            "testTitle": "テスト通話",
            "testQueued": "まもなく着信します。",
            "testVoiceHint": "1日1回のテスト通話。月間クォータに含まれます。",
            "saved": "設定を保存しました",
            "escalationTarget": "転送先",
            "escalationAuto": "自動(地域マネージャー)",
            "escalationTargetHint": "「自動」のままにすると地域マネージャーが選択されます。下から特定のマネージャーを選択することもできます。",
            "premium_active_title": "PREMIUM 利用中",
            "premium_until": "{{date}} に終了",
            "premium_days_left": "残り {{n}} 日",
            "renewBtn": "1ヶ月延長 (19,000 VND)"
        },
        "callHistory": {
            "title": "通話履歴",
            "attempts": "試行",
    ...
    "payment": {
        "in_app_title": "VNPay決済",
        "in_app_subtitle": "安全な取引セッション",
        "in_app_loading": "VNPayに接続中...",
        "success_title": "決済が完了しました",
        "success_desc": "PREMIUMプランは数秒以内に有効化されます。ご利用ありがとうございます。",
        "failed_title": "決済が完了しませんでした",
        "failed_desc_with_code": "取引が完了しませんでした（コード {{code}}）。もう一度お試しください。"
    }
}
