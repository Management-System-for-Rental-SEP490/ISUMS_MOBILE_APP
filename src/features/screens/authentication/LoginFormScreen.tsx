...
const LoginFormScreen = () => {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (/data\s*intent\s*is\s*null|intent\s*is\s*null|null\s*intent/i.test(raw)) {
        setErrorMsg(t("google_login_interrupted"));
        return;
      }
    ...
    >
      ...
      >
        ...
        >
          ...
          <View style={loginFormStyles.socialSection}>
            <View style={loginFormStyles.socialDivider}>
              <View style={loginFormStyles.socialDividerLine} />
              <Text style={loginFormStyles.socialDividerText}>{t("or")}</Text>
              <View style={loginFormStyles.socialDividerLine} />
            </View>
